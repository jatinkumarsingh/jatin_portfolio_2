                    ...
                    <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                        ...
                        >
                            ...
                            <p className="font-mono text-sm md:text-lg text-ink/80 mt-6 max-w-xl leading-relaxed">
                                Aspiring Generative AI Developer. Skilled in Python and modern web technologies (React, JavaScript). Experienced in building AI-powered applications using machine learning and NLP, including predictive models and text classification systems.
                            </p>
