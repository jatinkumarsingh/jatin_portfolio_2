...
const commands = [
    { prompt: "$ exam-score-prediction · model trained", result: "✓ Regression pipeline ready", delay: 0 },
    { prompt: "$ news-credibility-monitor · deployed", result: "✓ TF-IDF + Logistic Regression", delay: 800 },
    { prompt: "$ doctor-appointment-system · live", result: "✓ Video consultation enabled", delay: 1600 },
    { prompt: "$ shopsmart · CI/CD pipeline", result: "✓ Docker containerization complete", delay: 2400 },
];
