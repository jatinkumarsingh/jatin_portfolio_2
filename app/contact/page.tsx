...
/* ─── Data ─── */
const contactInfo = [
    { icon: <Mail size={18} />, label: "Email", value: "jatin.singh2024@nst.rishihood.edu.in", href: "mailto:jatin.singh2024@nst.rishihood.edu.in" },
    { icon: <MessageCircle size={18} />, label: "Phone", value: "+91 8736969458", href: "tel:+918736969458" },
    { icon: <MapPin size={18} />, label: "Location", value: "India · Remote worldwide" },
    { icon: <Clock size={18} />, label: "Response", value: "Usually same day" },
    { icon: <MessageCircle size={18} />, label: "Languages", value: "English, Hindi" },
];

const faqs = [
    { q: "What are you currently working on?", a: "I'm focused on building AI-powered applications using machine learning and NLP. I'm also exploring how to combine modern web technologies like Next.js and React with AI to create innovative solutions." },
    { q: "What technologies do you specialize in?", a: "My core skills are Python, TypeScript, JavaScript, React, Next.js, and modern AI/ML frameworks like LangChain and Gemini. I'm also experienced with PostgreSQL, Prisma, and containerization with Docker." },
    { q: "Are you open to collaboration or projects?", a: "Yes! I'm always interested in collaborating on interesting projects, especially those involving AI, machine learning, or full-stack web development. Feel free to reach out." },
    { q: "How did you solve 100+ LeetCode problems?", a: "Consistent practice with a focus on understanding patterns. I started with easier problems and gradually moved to medium and hard difficulty levels, learning different problem-solving techniques along the way." },
    { q: "What's your learning approach?", a: "I believe in learning by doing. I build projects, read documentation, contribute to open source, and solve coding challenges. Real-world application of concepts helps me understand them deeply." },
];
